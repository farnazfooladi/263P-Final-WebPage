...
(function(e, undefined) {
    ...
    (function(e, undefined) {
        ...
        function ot(e, t, r, i) {
            ...
            if (
                ((t ? t.ownerDocument || t : b) !== f && c(t),
                    (t = t || f),
                    (r = r || []), !e || "string" != typeof e)
            )
                return r;
        ...
        (c = ot.setDocument =
            function(e) {
                ...
                return t !== f && 9 === t.nodeType && t.documentElement ?
                    ((f = t),
                        (p = t.documentElement),
                        (h = !s(t)),
                        (n.attributes = lt(function(e) {
                            return (
                                ...
                                ct(R, ft, null == e.getAttribute("disabled")),
                        ...
                        (n.getById = lt(function(e) {
                            return (
                                (p.appendChild(e).id = v), !t.getElementsByName || !t.getElementsByName(v).length
                            );
                        })),
                        n.getById ?
                        ...
                        (y =
                            st(p.contains) || p.compareDocumentPosition ?
        ...
        (ot.matchesSelector = function(e, t) {
            if (
                ((e.ownerDocument || e) !== f && c(e),
                    (t = t.replace(Y, "='$1']")), !(!n.matchesSelector || !h || (g && g.test(t)) || (d && d.test(t))))
            )
                try {
                    var r = m.call(e, t);
                    if (
            ...
            var n = 0,
                ...
                a = function(a, l, c, p, h) {
                    ...
                    if (((v += x), o && x !== v)) {
                        ...
                        O.apply(p, y),
                            T && !a && y.length > 0 && v + t.length > 1 && ot.uniqueSort(p);
                    }
                    return T && ((w = N), (u = C)), b;
                };
            return o ? ut(a) : a;
        ...
        trigger: function(t, n, r, i) {
            ...
            if (
                ...
                while ((a = h[s++]) && !t.isPropagationStopped())
                    ...
                    (f = (H.get(a, "events") || {})[t.type] && H.get(a, "handle")),
                    f && f.apply(a, n),
                    (f = c && a[c]),
                    f &&
                    x.acceptData(a) &&
    ...
    x.fn.extend({
            ...
            domManip: function(e, t, n) {
                ...
                if (
                    ...
                    if (s)
                        for (
                            u = o[o.length - 1].ownerDocument, x.map(o, ht), l = 0; s > l; l++
                        )
                            (a = o[l]),
                            at.test(a.type || "") &&
        ...
        x.extend({
            clone: function(e, t, n) {
                ...
                if (t)
                    if (n)
                        for (
                            o = o || mt(e), s = s || mt(a), r = 0, i = o.length; i > r; r++
                        )
                            gt(o[r], s[r]);
                    else gt(e, a);
                return (
    ...
    function An(e, t, n) {
        ...
        if (!x.isEmptyObject(c)) {
            h ? "hidden" in h && (p = h.hidden) : (h = H.access(e, "fxshow", {})),
                o && (h.hidden = !p),
                p ?
                x(e).show() :
                l.done(function() {
